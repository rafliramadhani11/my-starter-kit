...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="{
    ...
    <body class="flex min-h-screen flex-col items-center gap-4 bg-theme px-6 dark:bg-darkTheme lg:justify-center">
        <header class="mt-6 flex w-full justify-end gap-x-3 lg:max-w-4xl">
            <x-theme />
            @if (Route::has('login'))
        ...
        <div
            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] lg:rounded-r-lg lg:rounded-t-none">
                    </div>
                </div>
            </main>
        </div>
